...
public class PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primary extends Statements {
    ...
    public PrimaryNoNewArray_lf_primary_lfno_arrayAccess_lf_primary(Statements parent, int invokingState) {
