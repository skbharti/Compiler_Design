...
public class PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary extends Statements {
    ...
    public PrimaryNoNewArray_lfno_primary_lfno_arrayAccess_lfno_primary(Statements parent, int invokingState) {
