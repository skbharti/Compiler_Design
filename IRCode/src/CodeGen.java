...
public class CodeGen {
    ...
    public void generateMips(ThreeAddCode q, Hashtable<String,AddrTableEntry> curAddTable, Hashtable<String,AddrTableEntry> preAddTable, Hashtable<Integer,String> regTable){
        try {
